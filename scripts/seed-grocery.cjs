...
// Load environment variables from the repository .env before using process.env
...
if (!databaseUrl) {
  throw new Error(
    'EXPO_PUBLIC_DATABASE_URL is required. Example: EXPO_PUBLIC_DATABASE_URL=... npm run seed:grocery'
  );
}
